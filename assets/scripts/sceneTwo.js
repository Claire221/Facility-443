...
function lookInside() {
    ...
    option1.addEventListener("click", function(){
        ...
        for(let i = 0; i < paragraphArray.length; i++) {
            // gameParagraph.innerText = paragraphArray[i]
            console.log(i)
        }
...
//     gameParagraph.innerText = "Quickly throwing the door open you jump inside and shut the door behind you, you lean upagainst the back of the door and try to slow your heart rate \
//                                 so you can listen to see where they are going. You sigh in relief when you realize that the footsteps dissapear as fast as they appeard. You turn around for \
//                                 the first time and your presented with a room exactly the same as the one that you just left. From the layout to the grime, you worry for a second that your going \
//                                 crazy and are back in the room you just woke up in. There is one thing thats different about this room though, and its the same thing you find your eyes drawn to. \
//                                 Sitting on one of the beds, strapped down exactly how you were is a young woman. She cant be older than 24, she has long dark hair which you cant tell if its her \
//                                 natural colour or caused by a buildup of dirt and grime. Shes wearing what looks like a long white tshirt that you think goes down to her knees but its hard to tell \
//                                 because shes sitting down. Her skin is pale and she has brusies and marks all over her arms, you have to swallow down the bile rising up your throat as you realise that \
//                                 some of them are needle marks. The last and most peculiar thing about her is she has glowing blue eyes, you would thing they would scare you but they dont. Instead you \
//                                 feel a rush of safety and comfort when you look at her. You take two quick steps closer to the bed \n\n 'Hi, Do you know where we are? I woke up in a room down the hall \
//                                 and I dont know whats going on.. I dont know who I am or why im here and when I try to remember I get a blinding pain right here' \n\n You say as you point to the side \
//                                 of your head"
    
//     option1.innerText = "Continue.."; 

//     option1.addEventListener("click", paragraphTwo, {once : true});
//     option2.classList.add("hidden")
// }

// function paragraphTwo() {
//     console.log("Paragraph Two")
//     removeBtn()
//     createNewBtn()
//     option2.classList.add("hidden")
    
//     gameParagraph.innerText = "The girl stares back at you with wide eyes, she whispers something but you dont catch what she says. \n\n What did you say? I cant hear you' you say as you lean in closer\
//                                 \n\n 'You shouldnt be here' the girl whispers again you pull away slightly and turn to look at her face again, you give her a puzzled look \n\n 'I dont know where to go \
//                                 do you know where we are? what are we doing here?' you say and gesture ar the room \n\n 'Were bad people' the woman replies, her voice shaking slightly \n\n 'What do you mean \
//                                 bad people? I dont remember anything' You reply, getting slightly frustrated. You need to get out of here and if this woman doesnt explain things faster your going to get caught \
//                                 \n\n  'They found us and brought us here, they say were wrong.. that we should exist. We go against nature' \n\n go against nature? what does she mean? you try to remember anything \
//                                 from before you woke up but you instantly get that pain in the side of you head again. Your knees buckle and you have to hold onto the side of the bed to stop yourself from hitting \
//                                 the floor. \n\n 'Found us where? what do you mean we go against nature?' You ask her, subconsiously you have reached out and grasped the womans forearm you slightyl shake it out of \
//                                 desperation as you talk to her"
    
//     option1.innerText = "Continue.."; 
//     option1.addEventListener("click", paragraphFour, {once : true});
// }
// function paragraphThree() {
//     console.log("Paragraph Three")

//     removeBtn()
//     createNewBtn()

    
//     gameParagraph.innerText = "'Home' replies the woman \n 'Home? isnt this out home?' you ask, your eyes pleading with her to give you answers but by the way your heart rate has picked up you already know them, you \
//                                 just havent admited it to yourself yet \n 'No, this isnt out home.. Well maybe for some of us who might have grown up here, but for the rest of us we were stolen. The people from this \
//                                 planet arrived at ours in a space ship, they came with their guns and their explosions when we faught back and they realized what we can do they stole us away. Said that they couldnt leave \
//                                 a weapon like that behind, think of how they can use us. So they brought us here, they are trying to replicate the gene that gives us our gifts to use on their people. Not having much luck though\
//                                 /n/n She lets out a small laugh as she says the last sentence but you hardly notice, you can hardly hear anything except the blood rushing to your ears. How can it be? You were stollen? Why cant \
//                                 you remember that? and how can you be from another planet when you've recognized the words the people here are saying? ";
...
//     console.log("Paragraph Four")

//     removeBtn()
//     createNewBtn()

    
//     gameParagraph.innerText =  "'Why dont I remember any of that? and how come I can understand what theyre saying when I hear them in the corridor?' /n/n She doesnt say anything but she turnes her head to the side \
//                                 and you straighten in shock. The side of her head just above her ear a small patch of her hair is completely shaved, you hadnt noticed it before because the hair ontop is long enough to \
//                                 cover it. You lean forward slightly to have a better look and see that there is a small pink scar running through the center of the patch. \n\n 'This is why you dont remember who you are \
//                                 and this is why you can understand them' As shes talking she lets go of her hair and it covers the patch back up so you would never know its there, she turns and looks at you \n\n 'Its some \
//                                 kind of chip, they realised that we couldnt communciate with them so they implanted one of these in us all so they could give us instructions better, its faster than trying to teach us new languages \
//                                 they can program it to any language and poof were fluent. They also use them to control us, there is a small wire that runs from the chip directly into out brain so if we misbehave they can give us a quck \
//                                 zap to get us back inline' The woman explains this very calmly like the revelation isnt completely making your world implode. \n\n You lift your hand up to the side of your head, your almost to scared to check \
//                                 but as you run your fingers over the spot just above your ear you feel the scar \n\n 'Yep, and you must have really pissed someone off to get fried this bad, but dont worry everything will come back in a few days\
//                                 its never permenant. \n\n Your just about to as her more questions when you hear the door handle turn. You look at the Woman in horror, her expression mirrors yours 'Hide' she whispers \n\n Where do you hide?"; 
...
//     option1.addEventListener("click", paragraphThree, {once : true});
//     option2.addEventListener("click", paragraphTwo, {once : true});

//     option1.innerText = "Hide under the bed"
//     option2.innerText = "Hide in the wardrobe"
// }
